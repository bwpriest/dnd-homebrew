...
\begin{monsterbox}{Avarr}
	...
	\begin{monsteraction}[Bite]
		\emph{Melee Weapon Attack}: +8 to hit, reach 5 ft., one target. \emph{Hit}: \dice{2d6 + 5} piercing damage.
	\end{monsteraction}

	\begin{monsteraction}[Claw]
		\emph{Melee Weapon Attack}: +8 to hit, reach 5 ft., one target. \emph{Hit}: \dice{1d10 + 5} slashing damage.
	\end{monsteraction}
...
\begin{monsterbox}{Snaak}
	...
	\begin{monsteraction}[Bite]
		\emph{Melee Weapon Attack}: +8 to hit, reach 5 ft., one target. \emph{Hit}: \dice{2d10 + 5} piercing damage, and the target is Grappled (escape DC 16). Until this grapple ends, the target is Restrained, and the Crocodile can't bite another target.
	\end{monsteraction}

	\begin{monsteraction}[Tail]
		\emph{Melee Weapon Attack}: +8 to hit, reach 5 ft., one target not grappled by Snaak. \emph{Hit}: \dice{2d8 + 5} bludgeoning damage. The target must succeed on a DC 16 Strength saving throw or be knocked prone.
	\end{monsteraction}

	\begin{monsteraction}[Drown]
		When Snaak is grappling an enemy in water, he can drag them to a watery grave. 
		The target must succeed a DC 16 Strength save or take \dice{4d10+5} bludgeoning damage. 
...
\begin{monsterbox}{ Pleath}
	...
	\monstersection{Actions}
	\begin{monsteraction}[Bite]
		\emph{Melee Weapon Attack}: +7 to hit, reach 10 ft., one target. \emph{Hit}: \dice{3d6 + 4} piercing damage.
	\end{monsteraction}
...
\begin{monsterbox}{ Nakal}
	...
	\hline%
	\stats[
    STR = \stat{17}, % This stat command will autocomplete the modifier for you
    DEX = \stat{11},
    CON = \stat{16},
    INT = \stat{5},
    WIS = \stat{13},
	...
	\begin{monsteraction}[Charge]
		If Nakal moves at least 20 ft. in a straight line towards a target and then hits it with a bite attack on the same turn, the target takes an extra \dice{3d6} piercing damage.
	...
	\begin{monsteraction}[Bite]
		...
		Every hour that elapsed, the creature must repeat the saving throw, reducing its hit point maximum by \dice{1d10} on a failure. 
...
\begin{monsterbox}{ Chippah}
	...
	\begin{monsteraction}[Bite]
		\emph{Melee Weapon Attack}: +10 to hit, reach 15 ft., one target. \emph{Hit}: \dice{3d8 + 6} piercing damage
	\end{monsteraction}

	\begin{monsteraction}[Claw]
		\emph{Melee Weapon Attack}: +10 to hit, reach 15 ft., one target. \emph{Hit}: \dice{2d6 + 6} slashing damage
	\end{monsteraction}

	\begin{monsteraction}[Tail]
		\emph{Melee Weapon Attack}: +10 to hit, reach 15 ft., one target. \emph{Hit}: \dice{3d8 + 6} bludgeoning damage.
	...
	\begin{monsteraction}[Steam Breath]
		(1 / summoning): Chippah exhales scalding steam in a 60 foot cone. Each creature in that area must make a DC 16 Constitution saving throw, taking \dice{12d6} fire damage ona failed save or half as much damage on a successful one. 
